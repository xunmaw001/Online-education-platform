            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">在线学习展示</span>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../zaixianxuexi/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../zaixianxuexi/detail.jsp?id='+item.id)"><span>{{item.zaixianxuexiName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 zaixianxuexiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            zaixianxuexiContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (kechngTypes != null && kechngTypes != "" && kechngTypes != "null") {
                param['kechngTypes'] = kechngTypes;
                            ...
                            // 获取列表数据
            http.request('zaixianxuexi/list', 'get', param, function(res) {
