				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yonghuName" id="yonghuName" lay-verify="required" placeholder="学生姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yonghuIdNumber" id="yonghuIdNumber"  lay-verify="required|identity"   placeholder="身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yonghuPhone" id="yonghuPhone"  lay-verify="required|phone"   placeholder="手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
