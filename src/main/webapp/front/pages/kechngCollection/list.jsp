            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">课程收藏展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                          ...
                          <div class="layui-inline" style="margin-bottom: 10px;">
                              ...
                              <div class="layui-input-inline">
                                  <input type="text" name="kechngName" id="kechngName" placeholder="课程名称" autocomplete="off" class="layui-input">
                              </div>
                          </div>
                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jump('../kechng/detail.jsp?id='+item.kechngId)">
                                        <a href="#" class="ng-prsliik">
                                          <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.kechngPhoto?item.kechngPhoto.split(',')[0]:''" />
                                          </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jump('../kechng/detail.jsp?id='+item.kechngId)"><span>{{item.kechngName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.newMoney"><span style="color: red;">{{item.newMoney}} RMB</span></div>
                                    <div class="ng-prslist-tit" ><span style="color: red;" @click="deleteKechngCollection(item.id)">删除 {{item.kechngName}} 收藏</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 kechngCollectionContent 字段去除无用字符 如果字段长度大于60  就截取到60
            kechngCollectionContent: function(val) {
                if (val) {
        ...
        methods: {
            ...
            ,deleteKechngCollection(id){
                var paramArray = [];
                paramArray.push(id);
                layui.http.requestJson(`kechngCollection/delete`, 'post',paramArray, function (res) {
                    if (res.code == 0) {
                        layer.msg('删除成功', {
                            time: 2000,
                            icon: 6
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#kechngName').val() != null && jquery('#kechngName').val() != "" && jquery('#kechngName').val() != "null" ) {
                param['kechngName'] = jquery('#kechngName').val();
            }
            ...
            // 当前表
                                // 获取列表数据
            http.request('kechngCollection/list', 'get', param, function(res) {
