...
var centerMenu = [
    ...
    ,{
        name: '课程收藏',
        url: '../kechngCollection/list.jsp'
    }
    ,{
        name: '在线学习收藏',
        url: '../zaixianxuexiCollection/list.jsp'
    }
...
var adminurl =  "http://localhost:8080/zaixianjiaoyupingtai/index.jsp";
