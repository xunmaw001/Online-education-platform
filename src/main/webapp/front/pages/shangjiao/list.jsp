            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">上交作业展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="shangjiaoName" id="shangjiaoName" placeholder="标题" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 shangjiaoContent 字段去除无用字符 如果字段长度大于60  就截取到60
            shangjiaoContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#shangjiaoName').val() != null && jquery('#shangjiaoName').val() != "" && jquery('#shangjiaoName').val() != "null" ) {
                param['shangjiaoName'] = jquery('#shangjiaoName').val();
            }
            ...
            if (kechngTypes != null && kechngTypes != "" && kechngTypes != "null") {
                param['kechngTypes'] = kechngTypes;
                            ...
                            // 获取列表数据
            http.request('shangjiao/list', 'get', param, function(res) {
